 ...
 * {@hide}
 */
public class HTCQualcommNoSimReadyRIL extends RIL implements CommandsInterface {
    ...
    public HTCQualcommNoSimReadyRIL(Context context, int networkMode, int cdmaSubscription) {
