...
/**
 * Custom Qualcomm No SimReady RIL for HTC using the latest Uicc stack
 *
 * {@hide}
 */
public class HTCQualcommUiccRIL extends HTCQualcommRIL implements CommandsInterface {
    ...
    public HTCQualcommUiccRIL(Context context, int networkMode, int cdmaSubscription) {
